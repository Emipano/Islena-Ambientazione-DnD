...
\titleformat{\chapter}{\Huge\bfseries}{\thechapter\hsp\textcolor{CadetBlue}{/}\hsp}{0pt}{\Huge\bfseries}
...
\begin{titlepage}
	\begin{tikzpicture}[remember picture, overlay]
		\node at (current page.center) {
			\includegraphics[width=\paperwidth, height=\paperheight]{/home/emiliano/Documenti/D&D/Islena/titlepageislena1.jpg}
		};
	\end{tikzpicture}
