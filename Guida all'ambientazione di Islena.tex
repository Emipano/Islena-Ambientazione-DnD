...
\definecolor{DNDDarkBlue}{rgb}{0.173, 0.290, 0.365} % Darker Blue #2C4A5D
...
{\huge\bfseries\color{DNDDarkBlue}} % Slightly smaller than \part
...
{\Large\bfseries\color{DNDDarkBlue}} % Smaller font than \chapter
...
{\fontsize{13}{16}\bfseries\color{DNDDarkBlue}} % Normal font, dark blue color, bold
...
\vspace{11.5cm}
\par
{\scshape\Huge \textcolor{MintCream}{\textbf{Guida \\
			all'Ambientazione}}}
\vfill
\par
