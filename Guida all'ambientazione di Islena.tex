...
{\Large\color{DNDDarkBlue}\bfseries} % Smaller font than \chapter
{\textcolor{DNDGold}{\thesection}} % Section number in gold
{1em} % Space between number and title
{\Large\scshape\bfseries} % Title in small caps
[\vspace{-0.16em}\titlerule] % Thin rule below title


% Custom subsubsection title format
\titleformat{\subsection}[block]
{\fontsize{13}{16}\color{DNDDarkBlue}\bfseries} % Normal font, dark blue color, bold
{\textcolor{DNDGold}{\thesubsection}} % Subsection number
{1em} % Space between number and title
{\fontsize{13}{17}\bfseries\scshape}
[] % No rule below
