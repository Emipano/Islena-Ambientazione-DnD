...
\definecolor{softroyalblue}{RGB}{70, 100, 160} % meno acceso di RoyalBlue
\usepackage[colorlinks=true,
linkcolor=black,
urlcolor=softroyalblue,
citecolor=softroyalblue]{hyperref}
\usepackage{float}
\usepackage{multirow}
\usepackage{multicol}
...
\begin{tikzpicture}
	...
	\node[yshift=-1.6cm, xshift=5cm] 
	{\includegraphics[width=8cm]{/home/emiliano/Documenti/D&D/Islena/imgs/dungeon_master.png}};
	
	\node[
	ellipse callout,
	callout absolute pointer={(2.5,2.3)},
	fill=blue!5,
	draw=black,
	thick,
	align=center,
	...
	{\Large Questa versione è del \textbf{\today},\\
	\Large\href{https://emipano.github.io/Islena/}{\textbf{clicca qui}} per controllare se ci sono aggiornamenti!};
...
\vfill
\begin{tcolorbox}[colback=CadetBlue!10!DNDWhite, colframe=CadetBlue!85!DNDGray, title=\fontsize{13}{15}\bfseries\textsc{Spostamento Planare e altri incantesimi}]
Incantesimi come \href{https://dndtools.net/spells/players-handbook-v35--6/plane-shift--2423/}{Spostamento Planare}, che normalmente permettono di viaggiare liberamente tra i piani subiranno delle leggere modifiche.
\begin{itemize}
	\item Il Mare di Stelle non è raggiungibile con nessun incantesimo che permette viaggi extraplanari.
	\item Gli Dei possono creare all'interno dei piani delle zone proibite non raggiungibili da incantesimi di viaggio extraplanare. Ad esempio se la maga Mialee, al 15° livello, lancia \href{https://www.dndtools.org/spells/spell-compendium--86/plane-shift-greater--4638/}{Spostamento Planare Superiore} tentando di raggiungere l'interno della fortezza di Immaru nel Fukai (che per qualche motivo ha visitato in precedenza), l'incantesimo non funziona pienamente e Mialee viene trasportata in un punto fuori dalla fortezza invece che nella posizione desiderata.
\end{itemize}
\label{planarshift}
\end{tcolorbox}
...
\\
\includegraphics[width = 7cm]{fukai.jpeg}
\\
...
\section{Sottopiani}
I Sottopiani sono delle sezioni dei Piani principali. Il loro scopo è quello trasporre i Piani Esterni della cosmologia canonica di D\&D nella nuova cosmologia senza lasciare troppi buchi.
Ad esempio l'Abisso e i Nove Inferi saranno sottopiani del Fukai, in questo modo possiamo mantenere la distinzione tra i luoghi di provenienza delle creature abissali e infernali e così via. 
Inoltre questo sistema consente piena libertà, se mai ci sarà il bisogno, di aggiungere altri piani di fantasia senza dover rivoluzionare l'intera cosmologia.\\
Questo sistema è intrinsecamente poco rigoroso e ogni caso verrà gestito a braccio. Al momento non penso ci sia il bisogno di analizzare ogni Piano Esterno esistente nella Grande Ruota per decidere se ha un senso che esista in questa cosmologia e in tal caso sotto quale Piano possa ricadere. Se si presenterà la necessità sarà fatto.\\
I Sottopiani sono raggiungibili dal loro piano madre o con incantesimi di spostamento planare.\\
Armi in metallo stellare non applicano il danno aggiuntivo contro creature che si trovano in un Sottopiano dello stesso Piano del loro Sottopiano di origine.\\
Per qualsiasi altra cosa, a meno di altre future eccezioni, consideriamo i Sottopiani come Piani veri e propri.
...
\subsection*{Coepius}
Dio della pietà, dell'agricoltura, del sole e dell'abbondanza, Coepius è neutrale buono. Chiamato anche Il Benefattore egli è venerato dai contadini che pregano per un'abbondante raccolto e dai personaggi buoni. Il verbo di Coepius prevede che i più forti e i più ricchi aiutino i più deboli e i più bisognosi. I domini a lui associati sono Sole, Bene e Guarigione. La sua arma è il falcetto.\\
\\
...
\begin{itemize}
	...
	\item \textbf{Legge:} LM
	\item \textbf{Situazione diplomatica:} Alleati: Alcuni degli stati di Caralla confinanti, Principato di Termia, Granducato di Giusoviate. Accordi commerciali con Al Mohlka; Nemici: Tribù di Noether	
\end{itemize}
...
\begin{itemize}
	...
	\item \textbf{Legge:} LN
	\item \textbf{Situazione diplomatica:} Alleati: Patti economici e di pace con staterelli di Caralla vicini
\end{itemize}
...
Questa era conosciuta come l'Età d'Oro di Caralla, durante la quale il regno espanse i suoi territori e consolidò la sua influenza su diverse regioni limitrofe. Il Re Alther III, noto come “Alther il Saggio”, fu uno dei sovrani più illustri, promuovendo riforme che portarono a un periodo di pace e prosperità senza precedenti.
...
Dopo la fine delle Guerre di Successione, il Regno di Caralla era ormai disintegrato in una miriade di piccoli stati indipendenti.
Il bisogno di unificazione tra i vari staterelli di Caralla divenne sempre più evidente. La situazione era caratterizzata da un'economia debole e conflitti locali, e molti ritenevano che solo una federazione potesse garantire stabilità e prosperità.
...
La mappa nel manuale può risultare piccola, per consultarla più comodamente e in grande potete cliccare \href{https://raw.githubusercontent.com/Emipano/Islena/main/imgs/islena_politica.jpg}{qui}.

\begin{figure}[h!]
	\includegraphics[width=\textwidth]{islena_politica.jpg}
...
Un'incantatrix non può applicare un talento di metamagia ad un oggetto magico ad attivazione se il livello dell'incantesimo contenuto nell'oggetto, aumentato del modificatore del talento di metamagia, supera il livello massimo di incantesimo che l'incantatrix è in grado di lanciare.
...
\textbf{Abilità:} Artigianato (fabbricazione di armaure) 6 gradi, Conoscenze (Religioni) 5 gradi\\
...
\textbf{Punire (Sop):} Al livello 2, un LdSA può spendere un uso giornaliero della propria capacità scacciare non morti come azione veloce per trasformare l’attacco in mischia in una punizione. Il personaggio ottiene un bonus pari al suo modificatore di Carisma ai tiri per colpire e infligge danni extra pari al suo livello effettivo totale di scacciare. Questa capacità di punire non è limitata dall'allineamento o dalla razza; il personaggio può tentare di colpire qualsiasi nemico. Un LdSA può decidere, oltre a spendere un uso di scacciare non morti, di sacrificare anche un incantesimo preparato o uno slot incantesimo. In questo caso, nei round successivi a quello in cui ha eseguito la punizione, l’LdSA ottiene un bonus sacro ai danni dell’arma pari al livello dell’incantesimo sacrificato, per un numero di round pari al suo livello effettivo di scacciare/$4$ (minimo $1$). Ad eccezione di quanto indicato qui, questa capacità funziona come la capacità \textit{punire il male} del Paladino (PH $44$).\\

\textbf{Lancio spontaneo modificato (Str):} Al livello 2, un LdSA perde la capacità di lanciare spontaneamente incantesimi curare. Invece, può sostituire gli incantesimi da chierico preparati in precedenza con qualsiasi incantesimo di livello uguale o inferiore dal dominio della Guerra.\\

\textbf{Arma specializzata:} Al livello 3, un LdSA ottiene il talento \textit{Arma specializzata} sull’arma della divinità. Se è già in possesso di questo talento, può sceglierne un altro dalla lista dei talenti del Guerriero.\\
...
\textbf{Colpo dell'ala affilata (Sop):} Al livello 12, una volta al giorno, il personaggio può usare una Spada Alata (vedi sopra) per abbattere un nemico. Un LdSA deve decidere di usare questa capacità prima che venga effettuato il tiro per colpire. Se l'attacco ha successo, il bersaglio deve superare un Tiro Salvezza su Tempra (CD $7$ + il livello da LdSA + il modificatore di Car) o morire.\\
...
In questa sezione sono riportati tutti i talenti che hanno subito cambiamenti rispetto alle regole originali.

\subsection{Metamagia Divina [\textsc{divino}]}
Il personaggio può incanalare energia in alcuni dei suoi incantesimi divini per renderli più potenti.\\
\textbf{Prerequisiti}: Capacità di scacciare o intimorire non morti\\
\textbf{Beneficio}: Quando seleziona questo talento, il personaggio sceglie un talento di metamagia che possiede. Questo talento si applica solo a quel talento di metamagia. Come azione gratuita, il personaggio può trarre l'energia dallo scacciare o intimorire non morti e usarla per applicare un talento di metamagia agli incantesimi divini che conosce. Deve spendere un tentativo di scacciare o intimorire non morti, più un tentativo extra per ogni incremento di livello nel talento di metamagia che sta usando. Per esempio, il chierico Jozan potrebbe sacrificare tre tentativi di scacciare per lanciare una \textit{punizione sacra} potenziata. Siccome sta sfruttando energia positiva o negativa per aumentare i propri incantesimi, lo slot incantesimo per l'incantesimo non cambia.\\
Il personaggio non può usare il talento Metamagia Divina per applicare talenti di metamagia che renderebbero il livello effettivo dell’incantesimo superiore al livello più alto di incantesimo che può normalmente lanciare.\\
\textbf{Speciale}: Questo talento può essere selezionato più volte. Ogni volta che seleziona questo talento, il personaggio sceglie un diverso talento di metamagia a cui applicarlo.

\subsection{Metamagia Pratica [\textsc{generale}]}
Il personaggio può applicare un talento di metamagia selezionato più facilmente.\\
\textbf{Prerequisiti}: Sapienza Magica 8 gradi, capacità di lanciare spontaneamente incantesimi arcani di 3° livello, qualsiasi talento di metamagia, sottotipo \textit{Dragonblood}\\
\textbf{Beneficio}: Quando seleziona questo talento, il personaggio sceglie un talento di metamagia che possiede. Quando il personaggio applica il talento di metamagia selezionato ad un incantesimo lanciato spontaneamente, l'incremento di livello dovuto al talento di metamagia viene ridotto di $1$, fino ad un minimo di +$1$. Tuttavia per determinare il livello di incantesimo massimo a cui si può applicare il talento di metamagia, si considera comunque l'aumento di livello originale.
Per esempio se lo stregone Hennet di 7° livello ha scelto Metamagia Pratica (Incantesimi Potenziati), può applicare Incantesimi Potenziati utilizzando slot di un solo livello più alto del normale invece che di due livelli più alto. Non può però applicare Incantesimi Focalizzati ad incantesimi di 2° livello perché a cose normali occuperebbero slot di 4° livello, che non possiede ancora.\\
\textbf{Speciale}: Questo talento può essere selezionato più volte. Ogni volta che seleziona questo talento, il personaggio sceglie un diverso talento di metamagia a cui applicarlo.

\subsection{Metamagia Rapida [\textsc{generale}]}
\label{rapidmetamagic}
Il personaggio possiede una padronanza straordinaria della sua magia, che permette di modificare gli incantesimi sul momento molto più rapidamente degli altri.\\
\textbf{Prerequisiti}: Sapienza Magica 6 gradi, abilità di lanciare incantesimi spontaneamente\\
\textbf{Beneficio}: Quando applichi un talento di metamagia a un incantesimo lanciato spontaneamente, il lancio impiega solo il tempo di lancio normale.\\
\textbf{Normale}: Un incantatore spontaneo che lancia un incantesimo metamagizzato impiega un'azione di round completo per incantesimi con tempo di lancio pari ad un'azione standard, o un'azione di round completo aggiuntiva per incantesimi con tempo di lancio più lungo.

\subsection{Asceta Ombra [\textsc{generale}]}
Il personaggio praticata una tecnica segreta che combina le sue notevoli abilità nel combattimento senz’armi con la profonda conoscenza del suo ki interiore\\
\textbf{Prerequisiti}: Potere \textit{ki}, colpo \textit{ki} (magia)\\
\textbf{Beneficio}: I livelli da monaco e da ninja si sommano al fine del calcolo degli utilizzi giornalieri dei poteri \textit{ki}. Per esempio, un monaco di 4° livello/ninja di 2° livello con questo talento può usare i suoi poteri ki un numero di volte al giorno pari a 3 (metà della somma tra i suoi livelli da monaco e da ninja) + il suo bonus di Saggezza (se ne ha uno).\\
I livelli da monaco e da ninja si sommano anche al fine di determinare il danno del colpo senz'armi, oltre alla capacità di classe colpo \textit{ki}. Per esempio, un monaco di 4° livello/ninja di 6° livello infligge $1$d$10$ danni col suo colpo senz'armi e può superare la riduzione del danno come un'arma allineata legale e magica (come un monaco di $10$° livello).\\
I livelli da monaco e da ninja si sommano anche al fine di determinare il bonus alla CA, tuttavia il bonus di Saggezza si somma una sola volta. Per esempio, un monaco di 8° livello/ninja di 7° livello ha un bonus alla CA pari a +3 + il suo bonus di Saggezza (come un monaco di $15$° livello).
Inoltre, il personaggio può diventare multiclasse liberamente tra le classi di monaco e ninja. Deve però rimanere legale per mantenere le proprie capacità da monaco e acquisire livelli da monaco. 
